export const runewords = [
    ...
    },
    {
        ...
        "Properties": [
            ...
            "9 to Minimum Damage",
            "Adds 5-60 Fire Damage",
            "+75 Poison Damage over 4 seconds",
            "+3-5 to Cleansing (Paladin Only)",
            "+5-7 to Prayer (Paladin Only)",
            "Hit Causes Monster to Flee 25%",
            "+15 to Dexterity",
            "Damage Reduced by 5-15",
            "Magic Damage Reduced by 5-15"
        ],
        "Type": "Scepters"
    },
    {
