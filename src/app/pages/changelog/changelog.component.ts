...
export const CHANGES = <IChange[]> [
	...
	<IChange>{
		...
		name: "Cube",
		href: "cube",
		changes: ["All recipes are disabled except for the following","Disenchant (DESTROYS) of magical or better item - Any Perfect Gem x2 + item + White Potion x3 = Jewels","Token of Absolution (reset stats and skills) - transmute key","Aeon's Lesser Blessing - any soul dust + jewel", "Aeon's Greater Blessing - Aeon's Lesser Blessing x4","Aeon's Greater Blessing - 4 different soul dusts + jewel","Secret cow level - Wirt's Leg + Key","Rejuvenation Potion (x3) - Super Healing Potion + Super Mana Potion + Jewel","Full Rejuvenation Potion (x3) - Rejuvenation Potion + Golden Potion","Add replenish quantity to arrows and bolts - Magic or rare arrows or bolts + Key"
		],
		subCat: [
			<IChange>{
				collapsed: false,
			...
			<IChange>{
				...
				href:"warped",
				changes: ["Make item warped - item + Any Perfect Gem x% + Jewel x5 + Golden Potion", "Cold resist +2% (+1 level req) - warped item + blank runestone + jewel + Perfect Saphire","Fire resist +2% (+1 level req) - warped item + blank runestone + jewel + Perfect Ruby","Lightning resist +2% (+1 level req) - warped item + blank runestone + jewel + Perfect Topaz","Poison resist +2% (+1 level req) - warped item + blank runestone + jewel + Perfect Emerald","Cold pierce +1% (+3 level req) - warped item + blank runestone x2 + jewel + Perfect Saphire","Fire pierce +1% (+3 level req) - warped item + blank runestone x2 + jewel + Perfect Ruby","Lightning pierce +1% (+3 level req) - warped item + blank runestone x2 + jewel + Perfect Topaz","Poison pierce +1% (+3 level req) - warped item + blank runestone x2 + jewel + Perfect Emerald","Life +2% and mana +1% steal (+1 level req) - warped item + blank runestone + jewel + Perfect Skull","Physic damage min and max +5 (+1 level req) - warped item + blank runestone + jewel + Perfect Amethyst","Magic damage +5 (+1 level req) - warped item + blank runestone + jewel + Perfect Diamond","Damage to undead and demons +2% (+1 level req) - warped item + blank runestone + jewel + Pul Rune","Health +10 and mana +5 (+1 level req) - warped item + blank runestone + jewel + Full Rejuvenation Potion (MEGA)","Magic find +2% and gold find +3% (+1 level req) - warped item + blank runestone + jewel + Lem Rune","Additional expirience +1% (+2 level req) - warped item + blank runestone + jewel + Um Rune","Level req reduce (-50 level req) - warped item + blank runestone + jewel + Zod Rune",
				]
			},
			<IChange> {
				name:"Timeless Item",
				href:"timeless",
				changes: ["Looped Time Fragment - Warped Rune x5 + Golden Potion","Make item Timeless - Superior nonsocketed gloves or boots + Looped Time Fragment x2 + Jewel","Add skill on Timeless item (+3 lvl req) - Timeless item + Perfect Gem (depends on class) + Jewel x5 + Key x? (depends on skill) + Looped Time Fragment",
